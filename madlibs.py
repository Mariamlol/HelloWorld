...
while True:
    if option == 1:
        ...
        number2 = input("Enter a number: ")  # if number>1 the noun has to be plural
        ...
        print("Done!\n")
        answer = input("Enter F to finish the game: ")
        if answer == "F":
            break
    ...
    if option == 3:
        ...
        print("I hope one day you can visit, although the only way to get here now is", verb_ing2, "on a", adjective8,
              noun12 + "!!\n")
        print("Done!\n")
        answer = input("Enter F to finish the game: ")
        if answer == "F":
